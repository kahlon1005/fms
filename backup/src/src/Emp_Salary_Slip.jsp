...
<report name="Emp_Salary_Slip" DTDVersion="9.0.2.0.10"
 beforeParameterFormTrigger="beforepform">
  <xmlSettings xmlTag="EMP_SALARY_SLIP" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="P_PERIOD" datatype="character" precision="10"
     defaultWidth="0" defaultHeight="0">
      <listOfValues restrictToList="yes">
        <selectStatement hideFirstColumn="no">
        <![CDATA[Select  PERIOD from fms_period
order by PERIOD_ID  DESC  ]]>
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL ORDER_INFO.TRIP_FROM, ORDER_INFO.TRIP_TO, 
ORDER_INFO.OPER_COMM, ORDER_INFO.TARIFF_CODE, ORDER_INFO.SHIP_TO||'-'||ORDER_INFO.SHIP_TO_NAME CONSIGNEE, 
ORDER_INFO.PERIOD, ORDER_INFO.EQUIPMENT, 
ORDER_INFO.OPERATOR, ORDER_INFO.CUSTOMER_NAME, ORDER_INFO.LOAD_DATE
FROM ORDER_INFO
ORDER BY ORDER_INFO.LOAD_DATE ASC ]]>
      </select>
      <displayInfo x="3.81677" y="1.03125" width="1.11035" height="0.32983"/>
      <group name="G_1">
        <displayInfo x="3.73218" y="1.87793" width="1.60120" height="0.77246"
        />
        <dataItem name="PERIOD" datatype="vchar2" columnOrder="16" width="6"
         defaultWidth="60000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Period">
          <dataDescriptor expression="ORDER_INFO.PERIOD"
           descriptiveExpression="PERIOD" order="6" width="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="OPERATOR" datatype="vchar2" columnOrder="18"
         width="20" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Employee Name">
          <dataDescriptor expression="ORDER_INFO.OPERATOR"
           descriptiveExpression="OPERATOR" order="8" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="SumOPER_COMMPerPERIOD" source="OPER_COMM"
         function="sum" width="22" precision="3" reset="G_1" compute="report"
      ...
      <group name="G_TRIP_FROM">
        <displayInfo x="3.74231" y="3.01880" width="1.59839" height="2.13965"
        />
        <dataItem name="EQUIPMENT" datatype="vchar2" columnOrder="17"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Truck">
          <dataDescriptor expression="ORDER_INFO.EQUIPMENT"
           descriptiveExpression="EQUIPMENT" order="7" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LOAD_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Load Date">
          <dataDescriptor expression="ORDER_INFO.LOAD_DATE"
           descriptiveExpression="LOAD_DATE" order="10" oracleDatatype="date"
           width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="CUSTOMER_NAME" datatype="vchar2" columnOrder="19"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Customer">
          <dataDescriptor expression="ORDER_INFO.CUSTOMER_NAME"
           descriptiveExpression="CUSTOMER_NAME" order="9" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="CONSIGNEE" datatype="vchar2" columnOrder="21"
         width="51" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Consignee">
          <dataDescriptor
           expression="ORDER_INFO.SHIP_TO || &apos;-&apos; || ORDER_INFO.SHIP_TO_NAME"
           descriptiveExpression="CONSIGNEE" order="5" width="51"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TRIP_FROM" datatype="vchar2" columnOrder="12"
         width="5" defaultWidth="50000" defaultHeight="10000" columnFlags="33"
         defaultLabel="From">
          <dataDescriptor expression="ORDER_INFO.TRIP_FROM"
           descriptiveExpression="TRIP_FROM" order="1" width="5"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TRIP_TO" datatype="vchar2" columnOrder="13" width="5"
         defaultWidth="50000" defaultHeight="10000" columnFlags="33"
         defaultLabel="To">
          <dataDescriptor expression="ORDER_INFO.TRIP_TO"
           descriptiveExpression="TRIP_TO" order="2" width="5"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TARIFF_CODE" datatype="vchar2" columnOrder="15"
         width="5" defaultWidth="50000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Tariff">
          <dataDescriptor expression="ORDER_INFO.TARIFF_CODE"
           descriptiveExpression="TARIFF_CODE" order="4" width="5"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="OPER_COMM" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="50000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Commision">
          <dataDescriptor expression="ORDER_INFO.OPER_COMM"
           descriptiveExpression="OPER_COMM" order="3" oracleDatatype="number"
    ...
    <dataSource name="Q_2">
      <select>
      <![CDATA[SELECT ALL FMS_PERIOD.PERIOD, FMS_PERIOD.PERIOD_ID
FROM FMS_PERIOD
WHERE FMS_PERIOD.PERIOD = :P_PERIOD
ORDER BY FMS_PERIOD.PERIOD_ID ASC ]]>
      </select>
      <displayInfo x="2.17700" y="1.36450" width="0.69995" height="0.30212"/>
      <group name="G_PERIOD1">
        <displayInfo x="1.94080" y="2.38745" width="1.18176" height="0.60156"
        />
        <dataItem name="PERIOD1" datatype="vchar2" columnOrder="23" width="6"
         defaultWidth="60000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Period1">
          <dataDescriptor expression="FMS_PERIOD.PERIOD"
           descriptiveExpression="PERIOD" order="1" width="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PERIOD_ID" oracleDatatype="number" columnOrder="24"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Period Id">
          <dataDescriptor expression="FMS_PERIOD.PERIOD_ID"
           descriptiveExpression="PERIOD_ID" order="2" oracleDatatype="number"
           width="22" precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <link name="L_1" parentGroup="G_PERIOD1" parentColumn="PERIOD1"
     childQuery="Q_1" childColumn="PERIOD" condition="eq" sqlClause="where"/>
  </data>
  <layout>
  <section name="main">
    <body>
      <frame name="M_G_PERIOD1_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.43750" height="0.56250"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_PERIOD1" source="G_PERIOD1"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_PERIOD1" source="PERIOD1" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="0.56250" y="0.00000" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_TRIP_FROM_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="7.43750"
             height="0.37500"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_TRIP_FROM" source="G_TRIP_FROM"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <field name="F_EQUIPMENT" source="EQUIPMENT" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="Book Antiqua" size="8"/>
                <geometryInfo x="0.00000" y="0.37500" width="0.56250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_LOAD_DATE" source="LOAD_DATE" minWidowLines="1"
               spacing="0" alignment="center">
                <font face="Book Antiqua" size="8"/>
                <geometryInfo x="0.56250" y="0.37500" width="0.75000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_CUSTOMER_NAME" source="CUSTOMER_NAME"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="Book Antiqua" size="8"/>
                <geometryInfo x="1.31250" y="0.37500" width="1.93750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_CONSIGNEE" source="CONSIGNEE" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="Book Antiqua" size="8"/>
                <geometryInfo x="3.43750" y="0.37500" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_TRIP_FROM" source="TRIP_FROM" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="Book Antiqua" size="8"/>
                <geometryInfo x="4.68750" y="0.37500" width="0.56250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_TRIP_TO" source="TRIP_TO" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="Book Antiqua" size="8"/>
                <geometryInfo x="5.37500" y="0.37500" width="0.56250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_TARIFF_CODE" source="TARIFF_CODE"
              ...
              <field name="F_OPER_COMM" source="OPER_COMM" minWidowLines="1"
            ...
            <frame name="M_G_TRIP_FROM_HDR">
              ...
              <text name="B_LOAD_DATE" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="0.56250" y="0.18750" width="0.75000"
                 height="0.18750"/>
              ...
              <text name="B_CUSTOMER_NAME" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="1.31250" y="0.18750" width="1.93750"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_CONSIGNEE" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="3.43750" y="0.18750" width="1.18750"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_TRIP_FROM" minWidowLines="1">
                ...
                <geometryInfo x="4.68750" y="0.18750" width="0.56250"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_TRIP_TO" minWidowLines="1">
                <textSettings justify="center" spacing="0"/>
                <geometryInfo x="5.37500" y="0.18750" width="0.56250"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_TARIFF_CODE" minWidowLines="1">
                <textSettings justify="center" spacing="0"/>
                <geometryInfo x="6.00000" y="0.18750" width="0.50000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_OPER_COMM" minWidowLines="1">
                <textSettings justify="end" spacing="0"/>
                <geometryInfo x="6.68750" y="0.18750" width="0.75000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="TableHeading"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_PERIOD1" minWidowLines="1">
            <textSettings spacing="0"/>
...
begin
  select max(PERIOD_ID) into :P_PERIOD from fms_period;
  return (TRUE);
end;]]>
      </textSource>
    </function>
...
<rw:dataArea id="MGPERIOD1GRPFR28">
<rw:foreach id="RGPERIOD1281" src="G_PERIOD1">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader">  <br>Period1 <rw:field id="F_PERIOD1" src="PERIOD1" breakLevel="RGPERIOD1281" breakValue="&nbsp;"> F_PERIOD1 </rw:field><br>
Period Id <rw:field id="F_PERIOD_ID" src="PERIOD_ID" breakLevel="RGPERIOD1281" breakValue="&nbsp;"> F_PERIOD_ID </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    ...
    <table class="OraTable" summary="">
     ...
     <thead>
      <tr>
       <th <rw:id id="HBEQUIPMENT28" asArray="no"/> class="OraColumnHeader"> Truck </th>
       <th <rw:id id="HBLOADDATE28" asArray="no"/> class="OraColumnHeader"> Load Date </th>
       <th <rw:id id="HBCUSTOMERNAME28" asArray="no"/> class="OraColumnHeader"> Customer </th>
       <th <rw:id id="HBCONSIGNEE28" asArray="no"/> class="OraColumnHeader"> Consignee </th>
       <th <rw:id id="HBTRIPFROM28" asArray="no"/> class="OraColumnHeader"> From </th>
       <th <rw:id id="HBTRIPTO28" asArray="no"/> class="OraColumnHeader"> To </th>
       <th <rw:id id="HBTARIFFCODE28" asArray="no"/> class="OraColumnHeader"> Tariff </th>
       <th <rw:id id="HBOPERCOMM28" asArray="no"/> class="OraColumnHeader"> Commision </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGTRIPFROM281" src="G_TRIP_FROM">
       <tr>
        <td <rw:headers id="HFEQUIPMENT28" src="HBEQUIPMENT28"/> class="OraCellText"><rw:field id="FEQUIPMENT28" src="EQUIPMENT" nullValue="&nbsp;"> F_EQUIPMENT </rw:field></td>
        <td <rw:headers id="HFLOADDATE28" src="HBLOADDATE28"/> class="OraCellText"><rw:field id="FLOADDATE28" src="LOAD_DATE" nullValue="&nbsp;"> F_LOAD_DATE </rw:field></td>
        <td <rw:headers id="HFCUSTOMERNAME28" src="HBCUSTOMERNAME28"/> class="OraCellText"><rw:field id="FCUSTOMERNAME28" src="CUSTOMER_NAME" nullValue="&nbsp;"> F_CUSTOMER_NAME </rw:field></td>
        <td <rw:headers id="HFCONSIGNEE28" src="HBCONSIGNEE28"/> class="OraCellText"><rw:field id="FCONSIGNEE28" src="CONSIGNEE" nullValue="&nbsp;"> F_CONSIGNEE </rw:field></td>
        <td <rw:headers id="HFTRIPFROM28" src="HBTRIPFROM28"/> class="OraCellText"><rw:field id="FTRIPFROM28" src="TRIP_FROM" nullValue="&nbsp;"> F_TRIP_FROM </rw:field></td>
        <td <rw:headers id="HFTRIPTO28" src="HBTRIPTO28"/> class="OraCellText"><rw:field id="FTRIPTO28" src="TRIP_TO" nullValue="&nbsp;"> F_TRIP_TO </rw:field></td>
        <td <rw:headers id="HFTARIFFCODE28" src="HBTARIFFCODE28"/> class="OraCellText"><rw:field id="FTARIFFCODE28" src="TARIFF_CODE" nullValue="&nbsp;"> F_TARIFF_CODE </rw:field></td>
        <td <rw:headers id="HFOPERCOMM28" src="HBOPERCOMM28"/> class="OraCellNumber"><rw:field id="FOPERCOMM28" src="OPER_COMM" nullValue="&nbsp;"> F_OPER_COMM </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
